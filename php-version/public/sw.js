const CACHE = 'mnm-php-assets-v35';
const ASSETS = ['assets/style.css','assets/admin.css','assets/icons.css','assets/php.css?v=28','assets/branding.css?v=3','assets/splash.js?v=3','assets/medinmedi-logo.png','assets/groupware-splash.jpg','assets/app.js?v=8','assets/attendance-sync.js?v=1','icons/groupware-180.png?v=2','icons/groupware-192.png','icons/groupware-512.png'];
