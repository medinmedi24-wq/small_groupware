...
<?php if($u): ?>
<div class="shell"><aside id="sidebar"><div class="brand sidebar-brand"><img src="assets/groupware-logo.png" alt="MEDI&amp;MEDI"></div><nav aria-label="주 메뉴">
<?php
$menu=['dashboard'=>'대시보드'];
...
<?php else: ?><div class="login"><?php if($page!=='setup'&&isset($_SESSION['csrf'])){formStart('login',[],'login-form');}else{echo '<div class="login-panel">';} ?><div class="brand login-brand"><img src="assets/groupware-logo.png" alt="메디앤메디 MEDI&amp;MEDI"></div><?php endif; ?>
